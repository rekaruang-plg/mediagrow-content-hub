...
import { Bell, CalendarClock, CheckCircle2, CircleAlert, Link2, RotateCcw, ShieldCheck } from "lucide-react";
...
export type NotificationTarget = "approval" | "content" | "calendar" | "meta";

export type WorkspaceNotification = {
  id: string;
  brandId: string;
  level: "critical" | "warning" | "info";
  kind: "publishing" | "review" | "connection";
  title: string;
  message: string;
...
const icons = { publishing: RotateCcw, review: ShieldCheck, connection: Link2 } as const;
