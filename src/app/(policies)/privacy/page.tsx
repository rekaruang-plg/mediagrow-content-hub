...
export default function PrivacyPage() {
  return <>
    <h1>Kebijakan Privasi</h1><p className="policy-date">Diperbarui: 8 September 2026</p>
    ...
    <p>Data workspace dapat diakses oleh anggota tim sesuai izin mereka dan oleh pengelola layanan untuk operasional serta dukungan. Layanan menggunakan Supabase untuk autentikasi, database dan penyimpanan berkas; Vercel untuk hosting aplikasi; serta layanan Meta untuk otorisasi dan publikasi. Penyedia tersebut memproses data yang diperlukan untuk menjalankan fungsinya. Infrastruktur penyedia dapat berada di luar negara pengguna.</p>
